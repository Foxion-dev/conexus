...
document.addEventListener("DOMContentLoaded", function () {
  var calculator = {
    ...
    changeReturnSum: function changeReturnSum(event) {
      if (this.customCommission) {
        var target = event.target;
        this.calculate(0, 0, target.value);
      }
    },
    changeCommissionSum: function changeCommissionSum(event) {
      if (this.customCommission) {
        var target = event.target;
    ...
    changeCustom: function changeCustom(event) {
    ...
    defaultCalculate: function defaultCalculate(event) {
      event.preventDefault();
      var target = event.target;
    ...
    calculate: function calculate() {
      var customCommission = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
      var customCommissionSum = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
      var customReturnSum = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
      var amountValue = +this.amountInput.value;
      var commissionPercent = customCommission > 0 ? customCommission : +this.commissionInput.value;
      var commissionSum = +this.amountInput.value / 100 * commissionPercent;
      var repaidSum = +this.amountInput.value - this.commissionSum;
      var commissionMode = this.commissionMode;
  ...
  * */
  var selectCustom = {
    ...
    toggleList: function toggleList(_ref) {
      var target = _ref.target;
      var block = target.closest(".select-custom");
      block.classList.toggle("opened");
      if (block.classList.contains("opened")) {
        this.listBlock.style.maxHeight = "".concat(this.list.scrollHeight + 2, "px");
      } else {
    ...
    chooseValue: function chooseValue(_ref2) {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/main"], () => (__webpack_require__("./resources/saas/main.css")))
